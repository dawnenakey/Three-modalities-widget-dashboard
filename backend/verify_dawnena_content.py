#!/usr/bin/env python3
"""
Verify Content for dawnena@dozanu.com
"""
...
async def main():
    ...
    for site in websites:
        print(f"\n   ------------------------------------------------")
        print(f"   Site: {site.get('name')} ({site['url']})")
        ...
        for page in pages:
            ...
            print(f"      - {page['url']} ({len(sections)} sections, {media_count} with media)")
    ...
    if del_result.deleted_count > 0:
        ...
        print("   👌 User dawnena@icloud.com not found")
